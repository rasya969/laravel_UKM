        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="{{ route('kategori-experiences.index') }}" class="nav-link">
                  <i class="nav-icon bi bi-palette"></i>
                  <p>Experiences</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('pendidikans.index') }}" class="nav-link">
                  <i class="nav-icon bi bi-palette"></i>
                  <p>Experiences</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('sertifikats.index') }}" class="nav-link">
                  <i class="nav-icon bi bi-palette"></i>
                  <p>Experiences</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('tech-stacks.index') }}" class="nav-link">
                  <i class="nav-icon bi bi-palette"></i>
                  <p>Experiences</p>
                </a>
              </li>
